...
function JudgeDashboardPage() {
  ...
  const fetchJudgeDashboard = async () => {
    try {
      const response = await axios.get(
        `https://bias-event-score-system.onrender.com/api/societies/judge-dashboard/${judge.id}`
      );
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post(
        "https://bias-event-score-system.onrender.com/api/societies/submit-score",
        {
          judgeId: judge.id,
